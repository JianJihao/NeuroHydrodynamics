...
class ConvLSTM1DCell(nn.Module):
    ...
    def init_hidden(self, batch_size, length):
        ...
        return (torch.zeros(batch_size, self.hidden_dim, length, device=self.conv.weight.device),
                torch.zeros(batch_size, self.hidden_dim, out_length, device=self.conv.weight.device))
...
class ConvLSTM1D(nn.Module):
    ...
    def __init__(
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(ConvLSTM1DCell(input_dim=cur_input_dim,
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        ----------
        input_tensor: todo
            4-D Tensor either of shape (t, b, c, l) or (b, t, c, l)
        hidden_state: todo
...
class ConvLSTM2DCell(nn.Module):
    ...
    def init_hidden(self, batch_size, image_size):
        ...
        return (torch.zeros(batch_size, self.hidden_dim, height, width, device=self.conv.weight.device),
                torch.zeros(batch_size, self.hidden_dim, out_height, out_width, device=self.conv.weight.device))
